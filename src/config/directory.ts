...
export const api = {
  ...
  unbanUser: (userId: string) => `/api/admin/users/${userId}/unban`,
  adminJobs: "/api/admin/jobs",
  toggleJobStatus: (id: string) => `/api/admin/jobs/${id}/toggle-status`,
  adminDeleteJob: (id: string) => `/api/admin/jobs/${id}/delete`,
