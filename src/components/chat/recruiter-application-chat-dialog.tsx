...
import { ApplicationChatPanel } from "../chat/application-chat-panel";
import { MessageCircle } from "lucide-react";
import { useCurrentResumeContent } from "@/hooks/use-resume-content";
import { Message } from "@ai-sdk/react";

interface RecruiterApplicationChatDialogProps {
  resumeS3Url: string;
...
export const RecruiterApplicationChatDialog = ({
  resumeS3Url,
  jobDescription,
  candidateName,
  children,
}: RecruiterApplicationChatDialogProps) => {
  ...
  const defaultTrigger = (
    <Button className="w-full h-12 text-lg bg-[var(--r-blue)] text-white hover:bg-[var(--r-blue)]/80 mt-2 flex items-center gap-2">
